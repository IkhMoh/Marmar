...
const UserCardReel = ({ username, profile_image }: User) => {
  return (
    <div className="w-full h-fit">
      <div className="flex  items-center space-x-2">
        ...
        <button className="text-white  bg-transparent px-2.5 py-0.5 border border-white font-extrabold rounded-md cursor-pointer">follow</button>{" "}
      </div>
    </div>
  );
};
